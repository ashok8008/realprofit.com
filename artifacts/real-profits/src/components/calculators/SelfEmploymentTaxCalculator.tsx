    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-destructive/10 p-6 rounded-xl border border-destructive/20 text-center">
          ...
          <div className="text-3xl font-serif font-bold text-destructive">${Math.round(seTax).toLocaleString()}</div>
        ...
        <div className="bg-muted/30 p-6 rounded-xl border text-center">
          ...
          <div className="text-3xl font-serif font-bold">${Math.round(deductibleHalf).toLocaleString()}</div>
        ...
        <div className="bg-primary/10 p-6 rounded-xl border border-primary/20 text-center">
          ...
          <div className="text-3xl font-serif font-bold text-primary">${Math.round(netAfterSeTax).toLocaleString()}</div>
