...
export function Footer() {
  return (
    <>
      <section className="bg-[#f5c542] py-16">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          <h2 className="font-serif text-3xl md:text-4xl font-bold mb-4 text-gray-900">Stay Ahead With RealProfits</h2>
          <p className="text-gray-900/80 mb-8 max-w-xl mx-auto">
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
            <input 
              ...
              className="flex h-12 w-full rounded-md border border-gray-900/20 bg-white/90 px-3 py-2 text-sm text-gray-900 placeholder:text-gray-900/50 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 focus:ring-offset-[#f5c542]"
              required
            />
            <button type="submit" className="inline-flex h-12 items-center justify-center rounded-md bg-gray-900 text-white px-8 text-sm font-bold shadow transition-colors hover:bg-gray-800">
              Subscribe
            </button>
          </form>
        </div>
      ...
      <footer className="bg-[#1a1a2e] text-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div>
              <Link href="/" className="font-serif font-bold text-2xl tracking-tight block mb-4 text-white">
                RealProfits.
              </Link>
            ...
            <div>
              ...
              <ul className="space-y-3 text-white/70 text-sm">
                ...
                <li>hello@realprofits.com</li>
                <li>123 Financial Way, Suite 100<br/>San Francisco, CA 94105</li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-white/50 text-sm">&copy; {new Date().getFullYear()} RealProfits. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
